...
export const FavouritesIC = ({small}:{small?:boolean}) => {
    return (
        <img src="./src/resources/icons/Favourites.svg" alt="#" className="icon" style={small ? {width: "3vh", height: "3vh", marginRight: "0.25vw"} : {}}/>
    );
}

export const HomeIC = ({small}:{small?:boolean}) => {
    return (
        <img src="./src/resources/icons/Home.svg" alt="#" className="icon" style={small ? {width: "3vh", height: "3vh", marginRight: "0.25vw"} : {}}/>
    );
}
